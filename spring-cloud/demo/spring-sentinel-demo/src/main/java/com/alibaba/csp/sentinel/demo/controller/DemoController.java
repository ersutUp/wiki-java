...
import com.alibaba.csp.sentinel.demo.service.TestService;
...
public class DemoController {
    ...
    @GetMapping("/cmity/{name}")
    public String cmity(@PathVariable("name") String name) {
        return community.query(name);
    }

    @GetMapping("/cmity/find/{name}")
    public String cmityFind(@PathVariable("name") String name) {
